...
namespace DAL
{
    public class ImportDal
    {
        ...
        {
            string sql = @"select distinct AccountCode from T_imp_raw_tmp  where AccountCode not in(select jvcoa.AccountCode from JV_COASetting jvcoa where jvcoa.CoCd='" + cocd + "' )";
            SqlDataReader dr = SqlHelp.ExecuteReader(sql);
...
or TcodeType='T5' or TcodeType='T8') ";
        ...
        /// <param name="accountPerid"></param>
        /// <returns></returns>
        public DataTable bsSeleByProcMin(string CocdT8String, string accountPerid)
        {
            DataTable dt = null;
            SqlDataReader dataReader = null;
            //SqlParameter[] sp = { 
            ...
            SqlParameter[] sp = { 
                                       new SqlParameter("@CocdT8String", CocdT8String),
                                     new SqlParameter("@AccountPerid",accountPerid)

                                };
            sqlHelp.RunProc("ProcBs_Min1", sp, out dataReader);
            if (dataReader != null && dataReader.HasRows == true)
            {
                dt = new DataTable();
                dt.Load(dataReader);
        ...
        /// <returns></returns>
        public DataTable bsSeleByProc(string CocdT8String, string accountPerid)
        {
            DataTable dt = null;
            SqlDataReader dataReader = null;
            //SqlParameter[] sp = { 
            ...
            sqlHelp.RunProc("ProTest1", sp, out dataReader);
        ...
        /// 年初期末按公司
        /// </summary>
        /// <param name="CocdT8String"></param>
        /// <param name="accountPerid"></param>
        /// <returns></returns>
        public DataTable bsSeleByProcMonthChuByCoCd(string CocdT8String, string accountPerid)
        {
            DataTable dt = null;
            SqlDataReader dataReader = null;
            //SqlParameter[] sp = { 
            ...
            sqlHelp.RunProc("ProBsMonthChu2", sp, out dataReader);
            if (dataReader != null && dataReader.HasRows == true)
            {
                dt = new DataTable();
                dt.Load(dataReader);
        ...
        /// <param name="t8code"></param>
        /// <returns></returns>
        public DataTable bsSeleByProcMonthChu(string CocdT8String, string accountPerid)
        {
            DataTable dt = null;
            SqlDataReader dataReader = null;
            //SqlParameter[] sp = { 
            ...
            sqlHelp.RunProc("ProcBsMonthChu1", sp, out dataReader);
            if (dataReader != null && dataReader.HasRows == true)
            {
                dt = new DataTable();
                dt.Load(dataReader);
        ...
        /// <param name="t8code"></param>
        /// <returns></returns>
        public DataTable bsSeleByProcMonth(string CocdT8String, string accountPerid, string YearMonthQuarter)
        {
            DataTable dt = null;
            SqlDataReader dataReader = null;
            SqlParameter[] sp = { 
            ...
            sqlHelp.RunProc("ProcBsMonth1", sp, out dataReader);
            if (dataReader != null && dataReader.HasRows == true)
            {
                dt = new DataTable();
                dt.Load(dataReader);
