...
namespace MIS_Shell
{
    ...
    public partial class TCodeSetting : Form
    {
        ...
        private void bind(string fileName)
        {
            ...
            OleDbDataAdapter da = new OleDbDataAdapter("SELECT *  FROM [TCode$] where [Tcode Type] is not null", strConn);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    dr = dt.Rows[i];
                    if (tcodedal.TCodeSelectS(dr[0].ToString().Trim(), dr[1].ToString().Trim(), dr[2].ToString().Trim(), dr[3].ToString().Trim()).Rows.Count > 0)
                    {
                        dtCh.ImportRow(dr);
                        flag = true;
                    }
        ...
        {
            string TcodeType = dr["Tcode Type"].ToString().Trim();
            string Tcode = dr["Tcode"].ToString().Trim();
            string TcodeName = dr["Tcode Name"].ToString().Trim();
            string CoCd = dr["CoCd"].ToString().Trim();
        ...
        private void But_Insert_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable dtExists = tcodedal.TCodeSelectS(TcodeType, Tcode, TcodeName, CoCd);
