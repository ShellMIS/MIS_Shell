    ...
    public partial class JVDSMDC : Form
    {
        ...
        private void But_Insert_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (Nature.Trim().ToUpper() == "JV")//为部门的时候需要替换成SCL的
                    {
                    ...
                    else if (Nature.Trim().ToLower()!= "jv")//为油站的时候直接添加即可
                    {
        ...
        private void but_Select_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string CoCd = "";
                //黄晓艳修改
                if (comboCocd.SelectedValue!=null)
                {
                     CoCd = comboCocd.SelectedValue.ToString().Trim();
                }
                ...
                dt = jvdsmacdal.JVDSMDCSelectLike(DeptNameCH, DeptNamePinyin, Nature, HSC, CoCd, T0Code, T3Code, T5Code, SiteOpenDate, SiteAging, SiteStatus, TMCode, Acquired, Location, CRType,
