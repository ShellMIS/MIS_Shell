    ...
    public partial class TB : Form
    {
        ...
        private void btn_Select_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (item.Name.Trim() == "期初余额" || item.Name.Trim() == "期间余额" || item.Name.Trim() == "期间借方" || item.Name.Trim() == "期间贷方" || item.Name.Trim() == "期末余额")
                    {
                        item.DefaultCellStyle.Format = "N2";
                        item.DefaultCellStyle.Font = new Font("Arial", 10);
                        item.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                    }
                    else if (item.Name.Trim() == "科目代码" || item.Name.Trim() == "替换前科目代码" || item.Name.Trim() == "替换后科目代码")
                    {
                        item.DefaultCellStyle.Font = new Font("Arial", 10);
                    }
                    else
        ...
        private void btn_import_Click(object sender, EventArgs e)
        {
            ...
            {
                ImportToExcel.Export(dt, "试算平衡报表", "试算平衡报表", "", DateTime.Now.ToString());
